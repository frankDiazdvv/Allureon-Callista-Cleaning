...
import { Mail, Phone, Building2, Linkedin, Facebook } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            ...
            <p className="text-light text-sm leading-relaxed">
               Structured cleaning for high-trust professional environments
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <a href="mailto:info@allureoncallista.com" className="flex items-center gap-3 text-light hover:text-white transition">
              ...
              <li>
                <a href="tel:+14078080148" className="flex items-start gap-3 text-light hover:text-white transition">
            ...
            <ul className="flex flex-row gap-4 space-y-4 text-sm">
              ...
              <li className="flex items-start gap-3 text-light hover:text-blue-400">
                <Link href="https://www.linkedin.com/company/allureon-callista" target="_blank">
                  <Linkedin className="w-5 h-5 mt-0.5 flex-shrink-0 transition" />
                </Link>
              </li>
              <li className="flex items-start gap-3 text-light hover:text-blue-500">
                <Link href={"https://www.facebook.com/people/Allureon-Callista/61587173250844/?mibextid=wwXIfr&rdid=zVpSGoflAYIVwCPB&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1FUdX6TEtf%2F%3Fmibextid%3DwwXIfr"} target="_blank">
                  <Facebook className="w-5 h-5 mt-0.5 flex-shrink-0 transition" />
                </Link>  
              </li>
            </ul>
          </div>
